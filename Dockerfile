...
RUN apt update && \
    apt install -y python3 python3-pip python3-venv git wget libgl1-mesa-dev libglib2.0-0 libsm6 libxrender1 libxext6 libgoogle-perftools4 libgoogle-perftools-dev libtcmalloc-minimal4 libcusparse11 xdg-utils bc aria2 && \
...
ENV LD_PRELOAD=/usr/local/cuda-12.1/targets/x86_64-linux/lib/libcusparse.so.12:/usr/lib/x86_64-linux-gnu/libtcmalloc_minimal.so
